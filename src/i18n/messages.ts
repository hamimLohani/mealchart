...
export const en = {
  ...
  "errors.memberFieldsRequired": "Full name, join date, and phone number are required.",
...
export const bn: Record<MessageKey, string> = {
  ...
  "errors.memberFieldsRequired": "পূর্ণ নাম, যোগদানের তারিখ ও ফোন দরকার।",
  "errors.saveMemberFailed": "সদস্য সেভ ব্যর্থ।",
